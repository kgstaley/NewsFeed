...
const routeDebugger = debug("newsfeed:routing");
const routeDebuggerVerbose = debug("verbose:newsfeed:routing");

const SCHEMAS = {
  ROUTES: {
    PREFIX: "newsfeed:schemas.routes.prefix",
    ROUTE: "newsfeed:schemas.routes.route",
    ANONYMOUS: "newsfeed:schemas.routes.allowanonymous",
    ROLEAUTHORIZATION: "newsfeed:schemas.routes.roleauthorization"
  }
};
